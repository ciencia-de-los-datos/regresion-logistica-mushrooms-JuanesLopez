...
def pregunta_01():
    ...
    # df = pd.read_csv('C:/Users/jlopezl/OneDrive - Renting Colombia S.A/Archivos/Personal/Especialización/Ciencia de los datos/regresion-logistica-mushrooms-JuanesLopez/mushrooms.csv')
